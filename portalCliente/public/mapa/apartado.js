/* =========================================================
   apartado.js — Flujo de reserva de lote con Quentli
   ========================================================= */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ── Continuar al pago → llama create-reservation y redirige a Quentli ──
  document.getElementById('btn-continuar').addEventListener('click', function () {
    ...
    fetch(SUPABASE_URL + '/functions/v1/create-reservation', {
      ...
      body: JSON.stringify({ loteid: Number(loteid), desarrolloid: Number(desarrolloid) }),
    })
