-- ============================================================================
-- FIX: vista_pagos_cliente - Cambiar cargo_extra de desarrolloid a loteid
-- Problema: Sumaba TODOS los cargos_extra del desarrollo en cada corrida
-- Solución: Sumar solo los cargos_extra del lote específico
-- ============================================================================
...
SELECT auth.uid() AS user_id,
    ...
    COALESCE(( SELECT sum(ce.monto) AS sum
           FROM cargos_extra ce
          WHERE (ce.loteid = l.loteid)), (0)::numeric) AS cargo_extra_amount,
        CASE
